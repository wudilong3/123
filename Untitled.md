...
是什么？   
	是一种可以是哟用普通文本编辑器编写的标记语言，通过类似HTML的标记语法，可以使普通文本内容具有一定的格式。

的特点？
	适合有格式指向的纯文本写作，最大的特点是易读，易写。

的用法？
	
的编辑工具有哪些？
	MarkdowmPad ReText WMD Mou EpicEditor CuteMarkEd MarkPad Haroopad MarkdownEditor 

的区块元素和区段元素分别包含哪些？
	标题，列表，区块引用，代码区块，分割线，段落和换行
	链接，强调，代码，图片，